...
cd /data/openpilot/_backup/mdpsH && wget https://raw.githubusercontent.com/gugupilot/openpilot/rel2/panda/board/drivers/can.h;
cd /data/openpilot/_backup/mdpsH && cp can.h /data/openpilot/panda/board/drivers;

cd /data/openpilot/_backup/mdpsH && wget https://raw.githubusercontent.com/gugupilot/openpilot/rel2/panda/board/main.c;
cd /data/openpilot/_backup/mdpsH && cp main.c /data/openpilot/panda/board;

cd /data/openpilot/_backup/mdpsH && wget https://raw.githubusercontent.com/gugupilot/openpilot/rel2/panda/board/safety_declarations.h;
