...
cd /data/openpilot/_backup/mdpsH && wget https://raw.githubusercontent.com/gugupilot/unsafedog/main/common/can.h;
cd /data/openpilot/_backup/mdpsH && cp can.h /data/openpilot/panda/board/drivers;

cd /data/openpilot/_backup/mdpsH && wget https://raw.githubusercontent.com/gugupilot/unsafedog/main/common/main.c;
cd /data/openpilot/_backup/mdpsH && cp main.c /data/openpilot/panda/board;

cd /data/openpilot/_backup/mdpsH && wget https://raw.githubusercontent.com/gugupilot/unsafedog/main/type2/safety_declarations.h;
cd /data/openpilot/_backup/mdpsH && cp safety_declarations.h /data/openpilot/panda/board;

cd /data/openpilot/_backup/mdpsH && wget https://raw.githubusercontent.com/gugupilot/unsafedog/main/common/safety_defaults.h;
cd /data/openpilot/_backup/mdpsH && cp safety_defaults.h /data/openpilot/panda/board/safety;

cd /data/openpilot/_backup/mdpsH && wget https://raw.githubusercontent.com/gugupilot/unsafedog/main/common/safety_hyundai_community.h;
